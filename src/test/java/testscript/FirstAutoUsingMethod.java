...
public class FirstAutoUsingMethod {
...
public void Invalid() {
		...
		////ul[@class='navigation-top-menu navigation-top-menu-user-actions']
		 ...
		 firstname.sendKeys("32197$%^");
		 Thread.sleep(2000);
		 lastname.sendKeys("24167^$&");
		 Thread.sleep(2000);
		 
		 
		 email.sendKeys("abc.de.f.hij.kl");
		 Thread.sleep(2000);
		 cnfrmemail.sendKeys("abc.de.f.hij.kl");
		 Thread.sleep(2000);
		 ...
		 passwrd.sendKeys("11111111");
		 Thread.sleep(2000);
		 confirmpasswrd.sendKeys("11111111");
		 Thread.sleep(2000);
	...
	public static void main(String[] args) {
		...
		FirstAutoUsingMethod Obj1= new FirstAutoUsingMethod();
		Obj1.valid();
		Obj1.Invalid();
